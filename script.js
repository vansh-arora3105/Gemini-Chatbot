...
// API configuration
const API_KEY = "AIzaSyBd2croKdo_1OMQ-W_-sGuOeJ9z9ydQxRo"; // Your API key here
...
// Toggle visibility of disclaimer text
...
toggleThemeButton.addEventListener("click", () => {
  ...
  toggleThemeButton.innerText = isLightMode ? "dark_mode" : "light_mode";
  toggleDisclaimer(); // Toggle disclaimer visibility
});
